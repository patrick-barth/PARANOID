...
parser.add_argument('--split_ambiguous',	'-s',	action='store_true',	default=False,	help='Splits assignments of ambiguous peaks in results table into all appropriate subtypes')
...
def main(input,rna_subtypes,report_ambiguous,split_ambiguous,report_not_assigned,output):
	samples_collected = {}
...
main(input=args.input,
	...
	split_ambiguous=args.split_ambiguous,
